"""
Django settings for blockblock project.
...
SECRET_KEY = "django-insecure-yn+^7vrqy!&i-@*3(j%bfsvt6)h85t06iwv#-l7+@r9bgknpl!"
...
WSGI_APPLICATION = "blockblock.wsgi.application"
